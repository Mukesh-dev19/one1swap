...
import { Users, Target, Lightbulb, TrendingUp, BookOpen, Recycle, Heart } from "lucide-react";
...
const stats = [
  { label: "Students Joined", value: "500+", icon: Users },
  { label: "Resources Shared", value: "1,200+", icon: BookOpen },
  { label: "Items Exchanged", value: "800+", icon: Recycle },
  { label: "Campuses Active", value: "10+", icon: TrendingUp },
];
  ...
  <div className="min-h-screen pt-20 pb-12 px-4">
    <div className="container mx-auto max-w-4xl">
      ...
      <motion.section className="mb-16" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={3}>
        <h2 className="font-heading text-2xl font-bold text-center mb-8">OneSwap in Numbers</h2>
