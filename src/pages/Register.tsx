    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-glow">
      ...
      >
        <div className="text-center mb-6">
          <img src={logo} alt="OneSwap" className="h-14 w-14 rounded-xl mx-auto mb-3 object-cover shadow-soft" />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative mt-1">
              ...
              <Input id="password" type={showPw ? "text" : "password"} placeholder="Min 6 characters" className="pl-10 pr-10" value={password} onChange={(e) => setPassword(e.target.value)} />
